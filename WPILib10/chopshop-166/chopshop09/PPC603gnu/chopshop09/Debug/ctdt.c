...
void _GLOBAL__I__ZN8Robot16611CameraDriveEv();

void _GLOBAL__I__ZN7DispLog6PutOneEfff();

void _GLOBAL__I__ZN9SensorLog6PutOneEfffffiiiibbbbbbbbfffffff();

void _GLOBAL__I__ZN10Accel_Log26PutOneEfff();

void _GLOBAL__I__ZN12MemoryLog166C2Ej();

void _GLOBAL__I__ZN10PIDControlC2Ev();

void _GLOBAL__I_Team166DispenserObject();
...
void (*_ctors[])() =
    {
    _GLOBAL__I__ZN8Robot16611CameraDriveEv,
    ...
    _GLOBAL__I__ZN12MemoryLog166C2Ej,
    _GLOBAL__I__ZN10PIDControlC2Ev,
    _GLOBAL__I_Team166DispenserObject,
...
void _GLOBAL__D__ZN8Robot16611CameraDriveEv();

void _GLOBAL__D__ZN7DispLog6PutOneEfff();

void _GLOBAL__D__ZN9SensorLog6PutOneEfffffiiiibbbbbbbbfffffff();

void _GLOBAL__D__ZN10Accel_Log26PutOneEfff();

void _GLOBAL__D__ZN12MemoryLog166C2Ej();

void _GLOBAL__D__ZN10PIDControlC2Ev();

void _GLOBAL__D_Team166DispenserObject();
...
void (*_dtors[])() =
    {
    _GLOBAL__D__ZN8Robot16611CameraDriveEv,
    ...
    _GLOBAL__D__ZN12MemoryLog166C2Ej,
    _GLOBAL__D__ZN10PIDControlC2Ev,
    _GLOBAL__D_Team166DispenserObject,
